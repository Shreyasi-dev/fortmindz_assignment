...
import { TextField, Button, Grid, FormControl,AppBar, Toolbar, Typography, Avatar } from '@mui/material';
...
const UpdateEmployee = () => {
  ...
  return (
    ...
    <Grid item xs={12} style={{display:'flex', gap:'10px'}}>
      ...
      <Link to="/" variant="contained" style={{color:"white", textDecoration:"none"}} >
        Back to Home
      </Link>
      </Button>
    </Grid>
