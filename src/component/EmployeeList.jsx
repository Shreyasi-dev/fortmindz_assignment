...
toast.success("Employee data has been deleted successfully")
    }
  ...
  return (
    <>
    <Typography variant='h4' sx={{ fontWeight: 'bold', textTransform:'capitalize', textAlign:'center', marginBlock:'10px' }}>All Employees Details</Typography>
    ...
    <Table>
      ...
      <TableBody>
        {employees?.length === 0 ? (
        <TableRow><TableCell>No employee data is available</TableCell></TableRow>
